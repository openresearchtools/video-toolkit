...
def test_live_gamma_channel_math_tools_are_exposed():
    expected = {
        ...
        "procamp_vaapi_color_controls": ({"BRIGHT_CONTRAST", "HUE_CORRECT", "COLOR_BALANCE"}, {"CompositorNodeBrightContrast", "CompositorNodeHueSat", "CompositorNodeColorBalance"}),
        "opencl_tone_map": ({"TONEMAP", "HUE_CORRECT"}, {"CompositorNodeTonemap", "CompositorNodeHueCorrect"}),
        "vaapi_tone_map": ({"TONEMAP", "HUE_CORRECT"}, {"CompositorNodeTonemap", "CompositorNodeHueCorrect"}),
...
def test_professional_restoration_tools_are_present():
    expected = {
        ...
        "native_cuda_bwdif_deinterlace",
        "native_vulkan_bwdif_deinterlace",
        "native_yadif_deinterlace",
        "native_cuda_yadif_deinterlace",
        "native_estdif_deinterlace",
        "native_w3fdif_deinterlace",
        "native_qsv_deinterlace",
        "native_vaapi_deinterlace",
        "native_deshake_stabilize",
        "native_opencl_deshake_stabilize",
...
def test_native_filter_and_blur_tools_are_exposed():
    expected = {
        ...
        "native_opencl_unsharp_filter": {"FILTER"},
        "native_cas_sharpen": {"FILTER"},
        "native_elbg_posterize": {"POSTERIZE"},
        "native_sobel_edges": {"FILTER"},
        "native_opencl_sobel_edges": {"FILTER"},
        "native_prewitt_edges": {"FILTER"},
        "native_opencl_prewitt_edges": {"FILTER"},
        "native_opencl_roberts_edges": {"FILTER"},
        "native_kirsch_edges": {"FILTER"},
        "native_edge_detect": {"FILTER"},
        "native_erode_matte": {"DILATE_ERODE"},
        "native_opencl_erode_matte": {"DILATE_ERODE"},
        "native_dilate_matte": {"DILATE_ERODE"},
        "native_opencl_dilate_matte": {"DILATE_ERODE"},
        "native_convolution_sharpen": {"CONVOLVE"},
        "native_fftfilt_detail": {"FILTER"},
        "native_vaapi_sharpness": {"FILTER"},
        "native_average_blur": {"BLUR"},
        "native_opencl_average_blur": {"BLUR"},
        "native_vulkan_average_blur": {"BLUR"},
        "native_box_blur": {"BLUR"},
        "native_opencl_box_blur": {"BLUR"},
        "native_gaussian_blur": {"BLUR"},
        "native_vulkan_gaussian_blur": {"BLUR"},
        "native_bilateral_filter": {"BILATERAL_BLUR"},
        "native_cuda_bilateral_filter": {"BILATERAL_BLUR"},
...
def test_native_denoise_and_cleanup_tools_are_exposed():
    expected = {
        ...
        "native_vaapi_denoise": {"DENOISE"},
        "native_fft_denoise": {"DENOISE"},
        "native_nlmeans_denoise": {"DENOISE"},
        "native_opencl_nlmeans_denoise": {"DENOISE"},
        "native_vulkan_nlmeans_denoise": {"DENOISE"},
        "native_bm3d_denoise": {"DENOISE"},
        "native_dct_denoise": {"DENOISE"},
...
def test_native_analysis_graphlet_tools_are_exposed():
    expected = {
        ...
        "native_ffmpeg_vulkan_black_detect": {
            "CompositorNodeCombineColor",
            "CompositorNodeImageInfo",
            "CompositorNodeLevels",
            "CompositorNodeRGBToBW",
        ...
        "native_ffmpeg_vulkan_scene_detect": {
            "CompositorNodeCombineColor",
            "CompositorNodeImageInfo",
            "CompositorNodeLevels",
            "CompositorNodeRGBToBW",
        ...
        "native_ffmpeg_interlace_detect": {
            "CompositorNodeCombineColor",
            "CompositorNodeImageInfo",
            "CompositorNodeLevels",
            "CompositorNodeRGBToBW",
        ...
        "native_ffmpeg_xcorrelate_compare": {
            "CompositorNodeAlphaOver",
            "CompositorNodeBlur",
            "CompositorNodeCombineColor",
            "CompositorNodeDiffMatte",
...
def test_native_geometry_and_lens_tools_are_exposed():
    expected = {
        ...
        "native_cuda_scale_fit": {"SCALE"},
        "native_qsv_scale_fit": {"SCALE"},
        "native_vaapi_scale_fit": {"SCALE"},
        "native_vulkan_scale_fit": {"SCALE"},
        "native_compositor_center_crop": {"CROP"},
        "native_compositor_rotate_level": {"ROTATE"},
        "native_compositor_transpose_clockwise": {"ROTATE"},
        "native_opencl_transpose_clockwise": {"ROTATE"},
        "native_vaapi_transpose_clockwise": {"ROTATE"},
        "native_vulkan_transpose_clockwise": {"ROTATE"},
        "native_compositor_flip_horizontal": {"FLIP"},
        "native_vulkan_flip_horizontal": {"FLIP"},
        "native_compositor_flip_vertical": {"FLIP"},
        "native_vulkan_flip_vertical": {"FLIP"},
        "native_vulkan_flip_both": {"FLIP"},
...
def test_every_native_ffmpeg_compositor_filter_has_one_click_tool():
    ...
    filter_to_tool.update({
        filter_name: f"native_ffmpeg_interop_{'equals' if filter_name == '=' else filter_name}"
        for filter_name in NATIVE_FFMPEG_INTEROP_FILTERS
    })
    filter_to_tool.update({
        "chromakey": "native_chroma_key_matte",
        "chromakey_cuda": "native_cuda_chroma_key_matte",
        "colorkey": "native_color_key_matte",
        "colorkey_opencl": "native_opencl_color_key_matte",
        ...
        "blend_vulkan": "native_vulkan_blend_composite",
        ...
        "unsharp_opencl": "native_opencl_unsharp_filter",
        "cas": "native_cas_sharpen",
        "sobel": "native_sobel_edges",
        "sobel_opencl": "native_opencl_sobel_edges",
        "prewitt": "native_prewitt_edges",
        "prewitt_opencl": "native_opencl_prewitt_edges",
        "roberts": "native_roberts_edges",
        "roberts_opencl": "native_opencl_roberts_edges",
        "kirsch": "native_kirsch_edges",
        "edgedetect": "native_edge_detect",
        "erosion": "native_erode_matte",
        "erosion_opencl": "native_opencl_erode_matte",
        "dilation": "native_dilate_matte",
        "dilation_opencl": "native_opencl_dilate_matte",
        "convolution": "native_convolution_sharpen",
        "convolution_opencl": "native_opencl_convolution_filter",
        "fftfilt": "native_fftfilt_detail",
        "avgblur": "native_average_blur",
        "avgblur_opencl": "native_opencl_average_blur",
        "avgblur_vulkan": "native_vulkan_average_blur",
        "boxblur": "native_box_blur",
        "boxblur_opencl": "native_opencl_box_blur",
        "gblur": "native_gaussian_blur",
        "gblur_vulkan": "native_vulkan_gaussian_blur",
        "varblur": "native_variable_blur",
        "bilateral": "native_bilateral_filter",
        "bilateral_cuda": "native_cuda_bilateral_filter",
        ...
        "scale_cuda": "native_cuda_scale_fit",
        "scale_qsv": "native_qsv_scale_fit",
        "scale_vaapi": "native_vaapi_scale_fit",
        "scale_vulkan": "native_vulkan_scale_fit",
        "fillborders": "native_fillborders_repair",
        "floodfill": "native_floodfill_repair",
        "untile": "native_untile_extract",
        "v360": "native_v360_projection",
        "crop": "native_compositor_center_crop",
        "rotate": "native_compositor_rotate_level",
        "transpose": "native_compositor_transpose_clockwise",
        "transpose_opencl": "native_opencl_transpose_clockwise",
        "transpose_vaapi": "native_vaapi_transpose_clockwise",
        "transpose_vulkan": "native_vulkan_transpose_clockwise",
        "hflip": "native_compositor_flip_horizontal",
        "hflip_vulkan": "native_vulkan_flip_horizontal",
        "vflip": "native_compositor_flip_vertical",
        "vflip_vulkan": "native_vulkan_flip_vertical",
        "flip_vulkan": "native_vulkan_flip_both",
        "lenscorrection": "native_compositor_lens_correction",
        "hqdn3d": "native_hqdn3d_denoise",
        "chromanr": "native_chromanr_cleanup",
        "denoise_vaapi": "native_vaapi_denoise",
        "fftdnoiz": "native_fft_denoise",
        "nlmeans": "native_nlmeans_denoise",
        "nlmeans_opencl": "native_opencl_nlmeans_denoise",
        "nlmeans_vulkan": "native_vulkan_nlmeans_denoise",
        ...
        "tmedian": "native_temporal_median_preview",
        "xmedian": "native_xmedian_preview",
        "dedot": "native_dedot_cleanup",
        "dctdnoiz": "native_dct_denoise",
        "deband": "native_deband_cleanup",
        "gradfun": "native_gradfun_deband",
        "sharpness_vaapi": "native_vaapi_sharpness",
        "deblock": "native_deblock_cleanup",
        "deflicker": "native_deflicker_preview",
        "bwdif": "native_bwdif_deinterlace",
        "bwdif_cuda": "native_cuda_bwdif_deinterlace",
        "bwdif_vulkan": "native_vulkan_bwdif_deinterlace",
        "yadif": "native_yadif_deinterlace",
        "yadif_cuda": "native_cuda_yadif_deinterlace",
        "estdif": "native_estdif_deinterlace",
        "w3fdif": "native_w3fdif_deinterlace",
        "deinterlace_qsv": "native_qsv_deinterlace",
        "deinterlace_vaapi": "native_vaapi_deinterlace",
        "field": "native_field_extract_preview",
        "fieldhint": "native_field_hint_preview",
        "fieldmatch": "native_field_match_preview",
        "fieldorder": "native_field_order_preview",
        "setfield": "native_setfield_metadata",
        "separatefields": "native_separate_fields_preview",
        "repeatfields": "native_repeat_fields_preview",
        "telecine": "native_telecine_preview",
        "detelecine": "native_detelecine_preview",
        "decimate": "native_decimate_preview",
        "mpdecimate": "native_mpdecimate_preview",
        "mcdeint": "native_mcdeint_preview",
        "nnedi": "native_nnedi_preview",
        "deshake": "native_deshake_stabilize",
        "deshake_opencl": "native_opencl_deshake_stabilize",
        ...
        "showpalette": "native_ffmpeg_showpalette",
        "thumbnail": "native_ffmpeg_thumbnail",
        "thumbnail_cuda": "native_cuda_thumbnail",
        "signalstats": "native_ffmpeg_signal_stats",
        "colordetect": "native_ffmpeg_color_detect",
        "entropy": "native_ffmpeg_entropy",
        "blackdetect": "native_ffmpeg_black_detect",
        "blackdetect_vulkan": "native_ffmpeg_vulkan_black_detect",
        "blackframe": "native_ffmpeg_black_frame",
        "blockdetect": "native_ffmpeg_block_detect",
        "blurdetect": "native_ffmpeg_blur_detect",
        "cropdetect": "native_ffmpeg_crop_detect",
        "bbox": "native_ffmpeg_bbox_detect",
        "bitplanenoise": "native_ffmpeg_bitplane_noise",
        "freezedetect": "native_ffmpeg_freeze_detect",
        "scdet": "native_ffmpeg_scene_detect",
        "scdet_vulkan": "native_ffmpeg_vulkan_scene_detect",
        "vfrdet": "native_ffmpeg_vfr_detect",
        "idet": "native_ffmpeg_interlace_detect",
        "identity": "native_ffmpeg_identity_compare",
        "ssim": "native_ffmpeg_ssim_compare",
        "psnr": "native_ffmpeg_psnr_compare",
        "xpsnr": "native_ffmpeg_xpsnr_compare",
        "corr": "native_ffmpeg_corr_compare",
        "msad": "native_ffmpeg_msad_compare",
