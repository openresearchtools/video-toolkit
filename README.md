...
- Native Blender primitives: VSE Brightness/Contrast, Lift/Gamma/Gain, ASC CDL Offset/Power/Slope, R/D Photoreceptor Tone Map, Rh Simple Tone Map, Curves, Hue Correct, White Balance, Mask, plus one-click compositor primitive graphs for Exposure, Color Correction, Hue/Saturation/Value, Invert, Posterize, Premul Key, and the combined all-compositor-color-primitives graph.
- Native matte/channel tools: translated FFmpeg keying and channel intent as Blender compositor Chroma Matte, Color Matte, Luma Matte, RGBA/chroma channel shift, luma/alpha plane extract, premultiply/straight-alpha conversion, and BGR plane shuffle graphs.
...
- Native geometry/lens tools: translated FFmpeg scale, crop, rotate, transpose, horizontal/vertical flip, and lenscorrection intent as Blender compositor Scale, Crop, Rotate, Flip, and Lens Distortion graphs.
