...
- **Native compositor node stacks**: one-click static, sampled, reference-matched, and FFmpeg-translated color/restoration graphs plus a full native video-finishing node library created from the active movie strip using Blender's compositor nodes.
