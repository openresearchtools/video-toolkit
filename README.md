...
`alphaextract`, `extractplanes`, `pseudocolor`, `histeq`, `colorspace`,
`colormatrix`, `setparams`, `setrange`, and `zscale`, then adds editable
native Blender VSE modifiers, compositor matte/channel/plane nodes, and
Blender color-management settings instead of rendering a new file.
