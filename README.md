...
- Native matte/channel tools: translated FFmpeg keying and channel intent as Blender compositor Chroma Matte, Color Matte, Luma Matte, threshold/masked-threshold luma matte graphs, RGBA/chroma channel shift, luma/alpha plane extract, premultiply/straight-alpha conversion, BGR plane shuffle, Channel Matte, Difference Matte, Distance Matte, Keying, Color Spill, Box Mask Alpha, Ellipse Mask Alpha, Double Edge Mask Alpha, and Mask-to-SDF Alpha graphs.
