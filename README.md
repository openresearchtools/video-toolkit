...
`gblur`, `smartblur`, `sab`, `yaepblur`, `dblur`, `pseudocolor`, `histeq`, `colorspace`, `colormatrix`,
`setparams`, `setrange`, and `zscale`, then adds editable native Blender VSE
modifiers, compositor matte/channel/plane/alpha-conversion/blur nodes, and Blender
