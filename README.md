...
- Native analysis/utility nodes: one-click Blender compositor Levels Monitor, Image Info, Split Compare, Switch Compare, Cryptomatte, Cryptomatte V2, Map UV, Plane Track Deform, Z Combine, Sequencer Strip Info, Scene Time, Time, and Track Position graph helpers.
