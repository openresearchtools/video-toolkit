...
- Native filter/blur tools: translated FFmpeg spatial intent as Blender compositor graphs for ELBG posterize, unsharp, CAS sharpen, FFT detail filtering, Sobel/OpenCL Sobel, Prewitt/OpenCL Prewitt, OpenCL Roberts preview, Kirsch, edge detect, erosion/OpenCL erosion, dilation/OpenCL dilation, convolution sharpen, average/OpenCL/Vulkan average blur, box/OpenCL box blur, Gaussian/Vulkan Gaussian blur, bilateral/CUDA bilateral, smart/shape-adaptive/edge-preserving/directional blur, deband cleanup, gradfun anti-banding, and deblock cleanup.
...
- Native analysis/utility nodes: one-click Blender compositor Levels Monitor, Image Info, Normalize Luma, FFmpeg-translated Histogram, Temporal Histogram, Waveform, Vectorscope, CIE Scope, Data Scope, Oscilloscope, Pixel Scope, Signal Stats, Color Detect, Black Segment Detect, Vulkan Black Detect, Black Frame Detect, Block Artifact Detect, Blur Detect, Crop Detect, Bounding Box Detect, Bit Plane Noise Detect, Freeze Detect, Scene Change Detect, Vulkan Scene Detect, Variable Frame Rate Detect, Interlace Detect, Identity, SSIM, PSNR, XPSNR, Correlation, MSAD, and Cross-Correlation reference-quality diagnostic graphs, Image Coordinates, Relative to Pixel, Split Compare, Switch Compare, Cryptomatte, Cryptomatte V2, Map UV, Plane Track Deform, Z Combine, Sequencer Strip Info, Scene Time, Time, and Track Position graph helpers.
