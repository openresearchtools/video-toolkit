...
- Native matte/channel tools: translated FFmpeg keying, channel, and composite intent as Blender compositor Chroma Matte, Color Matte, Luma Matte, threshold/masked-threshold luma matte graphs, Alpha Over blend/tblend/lut2/tlut2 composites, maskedmerge luma-matte composites, mergeplanes channel routing, RGBA/chroma channel shift, luma/alpha plane extract, premultiply/straight-alpha conversion, BGR plane shuffle, Channel Matte, Difference Matte, Distance Matte, Keying, Color Spill, Box Mask Alpha, Ellipse Mask Alpha, Double Edge Mask Alpha, and Mask-to-SDF Alpha graphs.
