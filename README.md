...
- Native matte/channel tools: translated FFmpeg keying and channel intent as Blender compositor Chroma Matte, Color Matte, Luma Matte, RGBA/chroma channel shift, luma/alpha plane extract, BGR plane shuffle, and straight-alpha conversion graphs.
- Native filter/blur tools: translated FFmpeg spatial intent as Blender compositor graphs for unsharp, Sobel, Prewitt, Kirsch, edge detect, erosion, dilation, convolution sharpen, average/box/Gaussian/smart/directional blur, deband cleanup, and deblock cleanup.
