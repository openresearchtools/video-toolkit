...
`edgedetect`, `erosion`, `dilation`, `convolution`, `pseudocolor`, `histeq`, `colorspace`, `colormatrix`,
`setparams`, `setrange`, and `zscale`, then adds editable native Blender VSE
modifiers, compositor matte/channel/plane/alpha-conversion nodes, and Blender
