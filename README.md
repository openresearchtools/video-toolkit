...
- Live lighting normalization and matching: samples luma through time, creates keyframed Blender Brightness/Contrast correction to reduce flicker, or matches the active strip's lighting timeline to another selected reference strip without rendering a new file.
