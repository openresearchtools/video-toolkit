...
- Live Blender color room: Color Management, Sequencer input color space, exposure, gamma, white balance, view curve mapping, strip transform/crop/opacity, and editable live modifier stack.
