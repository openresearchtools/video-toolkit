...
`scripts/open_blender_video_filters.py` opens Blender for manual checking, registers the add-on from this checkout, selects a real video strip in the Sequencer, applies diagnostic grade plus sampled Color Management, white-balance, levels/gamma, hue/chroma, and pro-grade tools, and leaves the **Video Filters** panel open.
