...
assert 'compositor-native node(s): 45' in scene.video_toolkit_last_translation
...
assert 'compositor-native filter node(s): 45' in scene.video_toolkit_last_compositor_nodes
