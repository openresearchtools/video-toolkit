...
assert 'translated colorspace, normalize, colorlevels, colorcorrect, colorcontrast, selectivecolor, monochrome, colorize, greyedge, chromakey, colorkey, hsvkey, lumakey, rgbashift, chromashift, alphaextract, extractplanes, premultiply, unpremultiply, shuffleplanes, vibrance, pseudocolor, exposure, histeq, zscale' in scene.video_toolkit_last_translation
assert 'compositor-only native node(s): 11' in scene.video_toolkit_last_translation
...
assert 'Native-translated FFmpeg filters: 45' in catalog_report
assert 'Native-translated FFmpeg color filters: eq, hue, huesaturation' in catalog_report
assert 'Native compositor-only FFmpeg filters: chromakey, colorkey, hsvkey, lumakey, rgbashift, chromashift, alphaextract, extractplanes, premultiply, unpremultiply, shuffleplanes' in catalog_report
...
assert 'compositor-only filter node(s): 11' in scene.video_toolkit_last_compositor_nodes
